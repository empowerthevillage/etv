...
urlpatterns = [
    ...
    path("integration_test_1/", integration_test_1, name="integration_test_1"),
    path("accounts/", RedirectView.as_view(url="/account")),
    path(
        "account/", include(("accounts.urls", "accounts"), namespace="account")
    ),
    path(
        "black-friday-challenge/",
        include(("bfchallenge.urls", "bfchallenge"), namespace="bfchallenge"),
    ),
    path(
        "billing/", include(("billing.urls", "billing"), namespace="billing")
    ),
    ...
    path(
        "logout/",
        LogoutView.as_view(next_page=settings.LOUGOUT_REDIRECT_URL),
        name="logout",
    ),
    ...
    path(
        "merchandise/",
        include(("merchandise.urls", "merchandise"), namespace="merchandise"),
    ),
    ...
    path(
        "village-black-pages/", include(("vbp.urls", "vbp"), namespace="vbp")
    ),
    path("", include("social_django.urls", namespace="social")),
    path(
        "health-and-wellness/",
        include(("health.urls", "health"), namespace="health"),
    ),
    path(
        "policy-and-power/",
        include(("policy.urls", "policy"), namespace="policy"),
    ),
    path(
        "education/",
    ...
    path(
        "unity-walk-2026/",
        include(("walkathon.urls", "walkathon"), namespace="power-walk-26"),
    ),
    # path(
    #     "annual-power-walk/",
    #     include(
    ...
    path(
        "village-empowerment-network-nomination/",
        venForm,
        name="ven-nomination",
    ),
