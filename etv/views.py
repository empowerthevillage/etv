...
def sitemap(request):
    return HttpResponse(
        open("etv/sitemap.xml").read(), content_type="text/xml"
    )
...
def about_page(request):
    context = {"title": "ETV | About"}
    return render(request, "about.html", context)


def integration_test_1(request):
    context = {"title": "ETV | Integration Test 1"}
    return render(request, "integration_test_1.html", context)


def privacy(request):
    context = {"title": "ETV | Privacy Policy"}
    return render(request, "privacy.html", context)


def terms(request):
    context = {"title": "ETV | Terms & Conditions"}
    return render(request, "terms.html", context)


def strategic_pillars(request):
    context = {"title": "ETV | Strategic Pillars"}
...
def news(request):
    context = {"title": "ETV | News"}
    return render(request, "news.html", context)


def careers(request):
    context = {"title": "ETV | Careers"}
