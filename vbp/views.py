...
def getStateListings(request):
    ...
    if state == 'US-TX':
        covers_qs = vbp_book.objects.filter(published=True).order_by('-featured', 'state')
        state_qs = list(vbp_tx.objects.all().order_by('category', 'city', 'business_name')),
        beauty_full = vbp_tx.objects.filter(approved=True).filter(category='beauty').exclude(city='').order_by('city', 'business_name')
        beauty_blank = vbp_tx.objects.filter(approved=True).filter(category='beauty').filter(city='').order_by('business_name')
        beauty = list(beauty_full) + list(beauty_blank)
        books_full = vbp_tx.objects.filter(approved=True).filter(category='books').exclude(city='').order_by('city', 'business_name')
        books_blank = vbp_tx.objects.filter(approved=True).filter(category='books').filter(city='').order_by('business_name')
        books = list(books_full) + list(books_blank)
        cars_full = vbp_tx.objects.filter(approved=True).filter(category='cars').exclude(city='').order_by('city', 'business_name')
        cars_blank = vbp_tx.objects.filter(approved=True).filter(category='cars').filter(city='').order_by('business_name')
        cars = list(cars_full) + list(cars_blank)
        child_full = vbp_tx.objects.filter(approved=True).filter(category='child').exclude(city='').order_by('city', 'business_name')
        child_blank = vbp_tx.objects.filter(approved=True).filter(category='child').filter(city='').order_by('business_name')
        child = list(child_full) + list(child_blank)
        cleaning_full = vbp_tx.objects.filter(approved=True).filter(category='cleaning').exclude(city='').order_by('city', 'business_name')
        cleaning_blank = vbp_tx.objects.filter(approved=True).filter(category='cleaning').filter(city='').order_by('business_name')
        cleaning = list(cleaning_full) + list(cleaning_blank)
        clothing_full = vbp_tx.objects.filter(approved=True).filter(category='clothing').exclude(city='').order_by('city', 'business_name')
        clothing_blank = vbp_tx.objects.filter(approved=True).filter(category='clothing').filter(city='').order_by('business_name')
        clothing = list(clothing_full) + list(clothing_blank)
        construction_full = vbp_tx.objects.filter(approved=True).filter(category='construction').exclude(city='').order_by('city', 'business_name')
        construction_blank = vbp_tx.objects.filter(approved=True).filter(category='construction').filter(city='').order_by('business_name')
        construction = list(construction_full) + list(construction_blank)
        education_full = vbp_tx.objects.filter(approved=True).filter(category='education').exclude(city='').order_by('city', 'business_name')
        education_blank = vbp_tx.objects.filter(approved=True).filter(category='education').filter(city='').order_by('business_name')
        education = list(education_full) + list(education_blank)
        eldercare_full = vbp_tx.objects.filter(approved=True).filter(category='eldercare').exclude(city='').order_by('city', 'business_name')
        eldercare_blank = vbp_tx.objects.filter(approved=True).filter(category='eldercare').filter(city='').order_by('business_name')
        eldercare = list(eldercare_full) + list(eldercare_blank)
        electronics_full = vbp_tx.objects.filter(approved=True).filter(category='electronics').exclude(city='').order_by('city', 'business_name')
        electronics_blank = vbp_tx.objects.filter(approved=True).filter(category='electronics').filter(city='').order_by('business_name')
        electronics = list(electronics_full) + list(electronics_blank)
        entertainment_full = vbp_tx.objects.filter(approved=True).filter(category='entertainment').exclude(city='').order_by('city', 'business_name')
        entertainment_blank = vbp_tx.objects.filter(approved=True).filter(category='entertainment').filter(city='').order_by('business_name')
        entertainment = list(entertainment_full) + list(entertainment_blank)
        farming_full = vbp_tx.objects.filter(approved=True).filter(category='farming').exclude(city='').order_by('city', 'business_name')
        farming_blank = vbp_tx.objects.filter(approved=True).filter(category='farming').filter(city='').order_by('business_name')
        farming = list(farming_full) + list(farming_blank)
        florists_full = vbp_tx.objects.filter(approved=True).filter(category='florists').exclude(city='').order_by('city', 'business_name')
        florists_blank = vbp_tx.objects.filter(approved=True).filter(category='florists').filter(city='').order_by('business_name')
        florists = list(florists_full) + list(florists_blank)
        grocery_full = vbp_tx.objects.filter(approved=True).filter(category='grocery').exclude(city='').order_by('city', 'business_name')
        grocery_blank = vbp_tx.objects.filter(approved=True).filter(category='grocery').filter(city='').order_by('business_name')
        grocery = list(grocery_full) + list(grocery_blank)
        health_full = vbp_tx.objects.filter(approved=True).filter(category='health').exclude(city='').order_by('city', 'business_name')
        health_blank = vbp_tx.objects.filter(approved=True).filter(category='health').filter(city='').order_by('business_name')
        health = list(health_full) + list(health_blank)
        home_full = vbp_tx.objects.filter(approved=True).filter(category='home').exclude(city='').order_by('city', 'business_name')
        home_blank = vbp_tx.objects.filter(approved=True).filter(category='home').filter(city='').order_by('business_name')
        home = list(home_full) + list(home_blank)
        hotels_full = vbp_tx.objects.filter(approved=True).filter(category='hotels').exclude(city='').order_by('city', 'business_name')
        hotels_blank = vbp_tx.objects.filter(approved=True).filter(category='hotels').filter(city='').order_by('business_name')
        hotels = list(hotels_full) + list(hotels_blank)
        jewelry_full = vbp_tx.objects.filter(approved=True).filter(category='jewelry').exclude(city='').order_by('city', 'business_name')
        jewelry_blank = vbp_tx.objects.filter(approved=True).filter(category='jewelry').filter(city='').order_by('business_name')
        jewelry = list(jewelry_full) + list(jewelry_blank)
        legal_full = vbp_tx.objects.filter(approved=True).filter(category='legal').exclude(city='').order_by('city', 'business_name')
        legal_blank = vbp_tx.objects.filter(approved=True).filter(category='legal').filter(city='').order_by('business_name')
        legal = list(legal_full) + list(legal_blank)
        lifestyle_full = vbp_tx.objects.filter(approved=True).filter(category='lifestyle').exclude(city='').order_by('city', 'business_name')
        lifestyle_blank = vbp_tx.objects.filter(approved=True).filter(category='lifestyle').filter(city='').order_by('business_name')
        lifestyle = list(lifestyle_full) + list(lifestyle_blank)
        marketing_full = vbp_tx.objects.filter(approved=True).filter(category='marketing').exclude(city='').order_by('city', 'business_name')
        marketing_blank = vbp_tx.objects.filter(approved=True).filter(category='marketing').filter(city='').order_by('business_name')
        marketing = list(marketing_full) + list(marketing_blank)
        medical_full = vbp_tx.objects.filter(approved=True).filter(category='medical').exclude(city='').order_by('city', 'business_name')
        medical_blank = vbp_tx.objects.filter(approved=True).filter(category='medical').filter(city='').order_by('business_name')
        medical = list(medical_full) + list(medical_blank)
        other_full = vbp_tx.objects.filter(approved=True).filter(category='other').exclude(city='').order_by('city', 'business_name')
        other_blank = vbp_tx.objects.filter(approved=True).filter(category='other').filter(city='').order_by('business_name')
        other = list(other_full) + list(other_blank)
        packaging_full = vbp_tx.objects.filter(approved=True).filter(category='packaging').exclude(city='').order_by('city', 'business_name')
        packaging_blank = vbp_tx.objects.filter(approved=True).filter(category='packaging').filter(city='').order_by('business_name')
        packaging = list(packaging_full) + list(packaging_blank)
        pets_full = vbp_tx.objects.filter(approved=True).filter(category='pets').exclude(city='').order_by('city', 'business_name')
        pets_blank = vbp_tx.objects.filter(approved=True).filter(category='pets').filter(city='').order_by('business_name')
        pets = list(pets_full) + list(pets_blank)
        photography_full = vbp_tx.objects.filter(approved=True).filter(category='photography').exclude(city='').order_by('city', 'business_name')
        photography_blank = vbp_tx.objects.filter(approved=True).filter(category='photography').filter(city='').order_by('business_name')
        photography = list(photography_full) + list(photography_blank)
        professional_full = vbp_tx.objects.filter(approved=True).filter(category='professional').exclude(city='').order_by('city', 'business_name')
        professional_blank = vbp_tx.objects.filter(approved=True).filter(category='professional').filter(city='').order_by('business_name')
        professional = list(professional_full) + list(professional_blank)
        realestate_full = vbp_tx.objects.filter(approved=True).filter(category='realestate').exclude(city='').order_by('city', 'business_name')
        realestate_blank = vbp_tx.objects.filter(approved=True).filter(category='realestate').filter(city='').order_by('business_name')
        realestate = list(realestate_full) + list(realestate_blank)
        recreation_full = vbp_tx.objects.filter(approved=True).filter(category='recreation').exclude(city='').order_by('city', 'business_name')
        recreation_blank = vbp_tx.objects.filter(approved=True).filter(category='recreation').filter(city='').order_by('business_name')
        recreation = list(recreation_full) + list(recreation_blank)
        restaurants_full = vbp_tx.objects.filter(approved=True).filter(category='restaurants').exclude(city='').order_by('city', 'business_name')
        restaurants_blank = vbp_tx.objects.filter(approved=True).filter(category='restaurants').filter(city='').order_by('business_name')
        restaurants = list(restaurants_full) + list(restaurants_blank)
        security_full = vbp_tx.objects.filter(approved=True).filter(category='security').exclude(city='').order_by('city', 'business_name')
        security_blank = vbp_tx.objects.filter(approved=True).filter(category='security').filter(city='').order_by('business_name')
        security = list(security_full) + list(security_blank)
        transportation_full = vbp_tx.objects.filter(approved=True).filter(category='transportation').exclude(city='').order_by('city', 'business_name')
        transportation_blank = vbp_tx.objects.filter(approved=True).filter(category='transportation').filter(city='').order_by('business_name')
        transportation = list(transportation_full) + list(transportation_blank)
        visual_full = vbp_tx.objects.filter(approved=True).filter(category='visual').exclude(city='').order_by('city', 'business_name')
        visual_blank = vbp_tx.objects.filter(approved=True).filter(category='visual').filter(city='').order_by('business_name')
        visual = list(visual_full) + list(visual_blank)
        ...
        paginator_other = Paginator(other, 16)
        other_page = visual_page + paginator_visual.num_pages + 1
        f = StateFilter(request.GET, queryset=vbp_tx.objects.all())
        for object in state_qs:
            obj = list(object)
            paginator = Paginator(obj, 16)
        return render(request, 
