...
def getStateListings(request):
    ...
    if state == 'US-AL':
        ...
        beauty = list(vbp_al.objects.filter(approved=True).filter(category='beauty').order_by('city', 'business_name'))
        books = list(vbp_al.objects.filter(approved=True).filter(category='books').order_by('city', 'business_name'))
        cars = list(vbp_al.objects.filter(approved=True).filter(category='cars'))
        child = list(vbp_al.objects.filter(approved=True).filter(category='child'))
        cleaning = list(vbp_al.objects.filter(approved=True).filter(category='cleaning'))
        clothing = list(vbp_al.objects.filter(approved=True).filter(category='clothing'))
        construction = list(vbp_al.objects.filter(approved=True).filter(category='construction'))
        education = list(vbp_al.objects.filter(approved=True).filter(category='education'))
        eldercare = list(vbp_al.objects.filter(approved=True).filter(category='eldercare'))
        electronics = list(vbp_al.objects.filter(approved=True).filter(category='electronics'))
        entertainment = list(vbp_al.objects.filter(approved=True).filter(category='entertainment'))
        farming = list(vbp_al.objects.filter(approved=True).filter(category='farming'))
        florists = list(vbp_al.objects.filter(approved=True).filter(category='florists'))
        grocery = list(vbp_al.objects.filter(approved=True).filter(category='grocery'))
        health = list(vbp_al.objects.filter(approved=True).filter(category='health'))
        home = list(vbp_al.objects.filter(approved=True).filter(category='home'))
        hotels = list(vbp_al.objects.filter(approved=True).filter(category='hotels'))
        jewelry = list(vbp_al.objects.filter(approved=True).filter(category='jewelry'))
        legal = list(vbp_al.objects.filter(approved=True).filter(category='legal'))
        lifestyle = list(vbp_al.objects.filter(approved=True).filter(category='lifestyle'))
        marketing = list(vbp_al.objects.filter(approved=True).filter(category='marketing'))
        medical = list(vbp_al.objects.filter(approved=True).filter(category='medical'))
        other = list(vbp_al.objects.filter(approved=True).filter(category='other'))
        packaging = list(vbp_al.objects.filter(approved=True).filter(category='packaging'))
        pets = list(vbp_al.objects.filter(approved=True).filter(category='pets'))
        photography = list(vbp_al.objects.filter(approved=True).filter(category='photography'))
        professional = list(vbp_al.objects.filter(approved=True).filter(category='professional'))
        realestate = list(vbp_al.objects.filter(approved=True).filter(category='real estate'))
        recreation = list(vbp_al.objects.filter(approved=True).filter(category='recreation'))
        restaurants = list(vbp_al.objects.filter(approved=True).filter(category='restaurants'))
        security = list(vbp_al.objects.filter(approved=True).filter(category='security'))
        transportation = list(vbp_al.objects.filter(approved=True).filter(category='transportation'))
        visual = list(vbp_al.objects.filter(approved=True).filter(category='visual'))
    ...
    if state == 'US-AR':
        ...
        beauty = list(vbp_ar.objects.filter(approved=True).filter(category='beauty').order_by('city', 'business_name'))
        books = list(vbp_ar.objects.filter(approved=True).filter(category='books').order_by('city', 'business_name'))
        cars = list(vbp_ar.objects.filter(approved=True).filter(category='cars'))
        child = list(vbp_ar.objects.filter(approved=True).filter(category='child'))
        cleaning = list(vbp_ar.objects.filter(approved=True).filter(category='cleaning'))
        clothing = list(vbp_ar.objects.filter(approved=True).filter(category='clothing'))
        construction = list(vbp_ar.objects.filter(approved=True).filter(category='construction'))
        education = list(vbp_ar.objects.filter(approved=True).filter(category='education'))
        eldercare = list(vbp_ar.objects.filter(approved=True).filter(category='eldercare'))
        electronics = list(vbp_ar.objects.filter(approved=True).filter(category='electronics'))
        entertainment = list(vbp_ar.objects.filter(approved=True).filter(category='entertainment'))
        farming = list(vbp_ar.objects.filter(approved=True).filter(category='farming'))
        florists = list(vbp_ar.objects.filter(approved=True).filter(category='florists'))
        grocery = list(vbp_ar.objects.filter(approved=True).filter(category='grocery'))
        health = list(vbp_ar.objects.filter(approved=True).filter(category='health'))
        home = list(vbp_ar.objects.filter(approved=True).filter(category='home'))
        hotels = list(vbp_ar.objects.filter(approved=True).filter(category='hotels'))
        jewelry = list(vbp_ar.objects.filter(approved=True).filter(category='jewelry'))
        legal = list(vbp_ar.objects.filter(approved=True).filter(category='legal'))
        lifestyle = list(vbp_ar.objects.filter(approved=True).filter(category='lifestyle'))
        marketing = list(vbp_ar.objects.filter(approved=True).filter(category='marketing'))
        medical = list(vbp_ar.objects.filter(approved=True).filter(category='medical'))
        other = list(vbp_ar.objects.filter(approved=True).filter(category='other'))
        packaging = list(vbp_ar.objects.filter(approved=True).filter(category='packaging'))
        pets = list(vbp_ar.objects.filter(approved=True).filter(category='pets'))
        photography = list(vbp_ar.objects.filter(approved=True).filter(category='photography'))
        professional = list(vbp_ar.objects.filter(approved=True).filter(category='professional'))
        realestate = list(vbp_ar.objects.filter(approved=True).filter(category='real estate'))
        recreation = list(vbp_ar.objects.filter(approved=True).filter(category='recreation'))
        restaurants = list(vbp_ar.objects.filter(approved=True).filter(category='restaurants'))
        security = list(vbp_ar.objects.filter(approved=True).filter(category='security'))
        transportation = list(vbp_ar.objects.filter(approved=True).filter(category='transportation'))
        visual = list(vbp_ar.objects.filter(approved=True).filter(category='visual'))
