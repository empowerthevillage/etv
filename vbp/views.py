...
def listing_filter(request, state):
    ...
    data = request.GET
    f = StateFilter(data, queryset=model.objects.order_by('city', 'business_name'))
    filtered_qs = f.qs
...
def getStateListings(request):
    ...
    beauty_full = model.objects.filter(approved=True).filter(category='beauty').exclude(city='').order_by('city', 'business_name')
    ...
    books_full = model.objects.filter(approved=True).filter(category='books').exclude(city='').order_by('city', 'business_name')
    ...
    cars_full = model.objects.filter(approved=True).filter(category='cars').exclude(city='').order_by('city', 'business_name')
    ...
    child_full = model.objects.filter(approved=True).filter(category='child').exclude(city='').order_by('city', 'business_name')
    ...
    cleaning_full = model.objects.filter(approved=True).filter(category='cleaning').exclude(city='').order_by('city', 'business_name')
    ...
    clothing_full = model.objects.filter(approved=True).filter(category='clothing').exclude(city='').order_by('city', 'business_name')
    ...
    construction_full = model.objects.filter(approved=True).filter(category='construction').exclude(city='').order_by('city', 'business_name')
    ...
    education_full = model.objects.filter(approved=True).filter(category='education').exclude(city='').order_by('city', 'business_name')
    ...
    eldercare_full = model.objects.filter(approved=True).filter(category='eldercare').exclude(city='').order_by('city', 'business_name')
    ...
    electronics_full = model.objects.filter(approved=True).filter(category='electronics').exclude(city='').order_by('city', 'business_name')
    ...
    entertainment_full = model.objects.filter(approved=True).filter(category='entertainment').exclude(city='').order_by('city', 'business_name')
    ...
    farming_full = model.objects.filter(approved=True).filter(category='farming').exclude(city='').order_by('city', 'business_name')
    ...
    florists_full = model.objects.filter(approved=True).filter(category='florists').exclude(city='').order_by('city', 'business_name')
    ...
    grocery_full = model.objects.filter(approved=True).filter(category='grocery').exclude(city='').order_by('city', 'business_name')
    ...
    health_full = model.objects.filter(approved=True).filter(category='health').exclude(city='').order_by('city', 'business_name')
    ...
    home_full = model.objects.filter(approved=True).filter(category='home').exclude(city='').order_by('city', 'business_name')
    ...
    hotels_full = model.objects.filter(approved=True).filter(category='hotels').exclude(city='').order_by('city', 'business_name')
    ...
    jewelry_full = model.objects.filter(approved=True).filter(category='jewelry').exclude(city='').order_by('city', 'business_name')
    ...
    legal_full = model.objects.filter(approved=True).filter(category='legal').exclude(city='').order_by('city', 'business_name')
    ...
    lifestyle_full = model.objects.filter(approved=True).filter(category='lifestyle').exclude(city='').order_by('city', 'business_name')
    ...
    marketing_full = model.objects.filter(approved=True).filter(category='marketing').exclude(city='').order_by('city', 'business_name')
    ...
    medical_full = model.objects.filter(approved=True).filter(category='medical').exclude(city='').order_by('city', 'business_name')
    ...
    other_full = model.objects.filter(approved=True).filter(category='other').exclude(city='').order_by('city', 'business_name')
    ...
    packaging_full = model.objects.filter(approved=True).filter(category='packaging').exclude(city='').order_by('city', 'business_name')
    ...
    pets_full = model.objects.filter(approved=True).filter(category='pets').exclude(city='').order_by('city', 'business_name')
    ...
    photography_full = model.objects.filter(approved=True).filter(category='photography').exclude(city='').order_by('city', 'business_name')
    ...
    professional_full = model.objects.filter(approved=True).filter(category='professional').exclude(city='').order_by('city', 'business_name')
    ...
    realestate_full = model.objects.filter(approved=True).filter(category='realestate').exclude(city='').order_by('city', 'business_name')
    realestate_blank = model.objects.filter(approved=True).filter(category='realestate').filter(city='').order_by('business_name')
    realestate = list(realestate_full) + list(realestate_blank)
    recreation_full = model.objects.filter(approved=True).filter(category='recreation').exclude(city='').order_by('city', 'business_name')
    ...
    restaurants_full = model.objects.filter(approved=True).filter(category='restaurants').exclude(city='').order_by('city', 'business_name')
    ...
    security_full = model.objects.filter(approved=True).filter(category='security').exclude(city='').order_by('city', 'business_name')
    ...
    transportation_full = model.objects.filter(approved=True).filter(category='transportation').exclude(city='').order_by('city', 'business_name')
    ...
    visual_full = model.objects.filter(approved=True).filter(category='visual').exclude(city='').order_by('city', 'business_name')
