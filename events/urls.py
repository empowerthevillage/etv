...
urlpatterns = [
    ...
    path(
        "loa-gallery-cart/", full_gallery_cart_home, name="gallery-cart-home"
    ),
    ...
    path(
        "ticket-donation-update-cart/",
        ticket_cart_donation_update,
        name="ticket-update-donation-cart",
    ),
    path(
        "ticket-donation-remove/",
        ticket_cart_donation_remove,
        name="ticket-donation-remove",
    ),
    path(
        "ticket-ad-update-cart/",
        ticket_cart_ad_update,
        name="ticket-update-ad-cart",
    ),
    ...
    path("power-swing-silent-auction/", silent_auction, name="silent-auction"),
    path(
        "power-swing-silent-auction/buy-now/<item_id>",
        silent_auction_buy_now,
        name="silent-auction-buy-now",
    ),
    path("process-silent-auction-purchase/", process_silent_auction_purchase),
