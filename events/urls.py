...
urlpatterns = [
    ...
    path('2023-power-swing-silent-auction/', silent_auction, name="silent-auction"),
    path('2023-power-swing-silent-auction/buy-now/<item_id>', silent_auction_buy_now, name="silent-auction-buy-now"),
