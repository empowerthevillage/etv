...
class Nomination(models.Model):
    ...
    nominator_recommended = models.BooleanField(
    ...
    priority1 = models.CharField(
        max_length=270, blank=True, null=True, verbose_name="Priority #1"
    )
    other1 = models.CharField(
        max_length=270, blank=True, null=True, verbose_name="Priority #1"
    )
    priority2 = models.CharField(
        max_length=270, blank=True, null=True, verbose_name="Priority #2"
    )
    other2 = models.CharField(
        max_length=270, blank=True, null=True, verbose_name="Priority #2"
    )
    priority3 = models.CharField(
        max_length=270, blank=True, null=True, verbose_name="Priority #3"
    )
    other3 = models.CharField(
        max_length=270, blank=True, null=True, verbose_name="Priority #3"
    )
    structure = models.CharField(max_length=270, blank=True, null=True)
    created = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    updated = models.DateTimeField(auto_now=True, blank=True, null=True)
    expo_vendor = models.BooleanField(
        default=False,
        null=True,
        blank=True,
        verbose_name="Interested in being Expo Vendor",
    )
    pitch_comp = models.BooleanField(
        default=False,
        null=True,
        blank=True,
        verbose_name="Interested in Pitch Competition",
    )
